...
<?php 
  // untuk mendambah form & menyimpan inputan cekno ttp keliatan
    ...
    if(isset($_POST['submit']) && $_POST['submit'] == 'SIMPAN'){
      include 'upload.php';
      include 'form_matakuliah_insert.php';
    }
?>
<div style="width:700px;">
<form name="form" method="post" action="form_matakuliah.php" enctype="multipart/form-data">
<input type="hidden" id="angka_kredit"  name="angka_kredit"  value="<?php echo $_GET['id'];?>" />
  ...
  <?php for ($i=0; $i < $form; $i++) { ?>
    <tr>
      <td colspan="3"><h3>Mata Kuliah <?php echo $i+1; ?></h3> </td>
    </tr>
    <tr class="form-group">
    <!-- inputan -->
      <td>Matakuliah</td>
