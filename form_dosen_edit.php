...
<form name="form1" method="post" action="form_dosen_update.php" enctype="multipart/form-data">
<table class="table table-striped table-borered">
      ...
      <td>:</td>
      <td><input type="text" name="tgl_penilaian" id="tgl_penilaian" class="tgl form-control" 
      	  value="<?php echo $buff['tgl_penilaian']; ?>"></td>
      </tr>

      <tr class="form-group">
      <td>Nama</td>
      <td>:</td>
      <td><input type="text" name="nama_dosen" id="nama_dosen" class="form-control" 
          value="<?php echo $buff['nama_dosen']; ?>"></td>
      </tr>

      <tr class="form-group">
      <td>NIP/NIDN</td>
      <td>:</td>
      <td><input type="text" name="nidn" id="nidn" class="form-control" value="<?php echo $buff['nidn']; ?>"></td>
      </tr>

      <tr class="form-group">
      <td>No Seri Karpeg</td>
      <td>:</td>
      <td><input type="text" name="no_seri" id="no_seri" class="form-control" value="<?php echo $buff['no_seri']; ?>"></td>
      </tr>

      <tr class="form-group">
      <td>Tempat Lahir</td>
      <td>:</td>
      <td><input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control" value="<?php echo $buff['tempat_lahir']; ?>"></td>
      </tr>

      <tr class="form-group">
      <td>Tanggal Lahir</td>
      <td>:</td>
      <td><input type="text" name="tgl_lahir" id="tgl_lahir" class="tgl form-control" value="<?php echo $buff['tgl_lahir']; ?>"></td>
      </tr>
      ...
      <td>      
            ...
            <option value="<?php echo $buff['jenis_kelamin']; ?>"><?php echo $buff['jenis_kelamin']; ?></option>
            <option value="-">-</option>
      ...
      <td>      
            ...
            <option value="<?php echo $buff['pendidikan_akhir']; ?>"><?php echo $buff['pendidikan_akhir']; ?></option>
            <option value="-">-</option>
      ...
      <td>      
            ...
            <option value="<?php echo $buff['pangkat']; ?>"><?php echo $buff['pangkat']; ?></option>
            <option value="-">-</option>
      ...
      <td>      
            <select name="jabatan" id="jabatan" onChange="pilih_type(this.value)" class="form-control">
             <option value="<?php echo $buff['jabatan']; ?>"><?php echo $buff['jabatan']; ?></option>
            <option value="-">-</option>
      ...
      <td>TMT</td>
      <td>:</td>
      <td><input type="text" name="tmt" id="tmt" class="tgl form-control" value="<?php echo $buff['tmt']; ?>"></td>
      </tr>

      <tr class="form-group">
      <td>Fakultas/Jurusan</td>
      <td>:</td>
      <td><input type="text" name="fakultas" id="fakultas" class="form-control" value="<?php echo $buff['fakultas']; ?>"></td>
      </tr>

      <tr class="form-group">
      <td>Masa Kerja Golongan (Lama)</td>
      <td>:</td>
      <td><input type="text" name="mk_lama" id="mk_lama" class="form-control" value="<?php echo $buff['mk_lama']; ?>"></td>
      </tr>

      <tr class="form-group">
      <td>Masa Kerja Golongan (Baru)</td>
      <td>:</td>
      <td><input type="text" name="mk_baru" id="mk_baru" class="form-control" value="<?php echo $buff['mk_baru']; ?>"></td>
      </tr>
      ...
      <td>      
            ...
            <option value="<?php echo $buff['usulan_jabatan']; ?>"><?php echo $buff['usulan_jabatan']; ?></option>
            <option value="-">-</option>
            <option value="Asisten Ahli">Asisten Ahli</option>
            <option value="Lektor">Lektor</option>
            <option value="Lektor Kepala">Lektor Kepala</option>
